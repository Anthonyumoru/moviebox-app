...
function App() {
  ...
  // ===== TIPS: Track view when video plays =====
  ...
  // ===== TIPS: Check verification eligibility =====
  ...
  // ===== TIPS: Fetch banks for creator signup =====
  ...
  // ===== TIPS: Assign movie to creator (admin) =====
  ...
  // Helper: check if current creator is verified
  const isVerified = creatorDashboard && (creatorDashboard.is_verified || (creatorDashboard.creator && creatorDashboard.creator.is_verified));
            ...
            <>
              <label style={{ cursor: "pointer", display: "flex", alignItems: "center", gap: "6px" }}>
                ...
                <span style={{ fontSize: "14px", color: "#888" }}>
                  @{user.username}
                  {isVerified && (
                    <span title="Verified Creator" style={{ color: "#1DA1F2", fontSize: "13px", marginLeft: "2px" }}>✔️</span>
                  )}
                </span>
              ...
              <>
                ...
                {!isVerified && (
                  <button onClick={checkVerification} style={{ width: "100%", padding: "12px", background: "#1DA1F2", color: "white", border: "none", borderRadius: "8px", cursor: "pointer", fontWeight: "600", fontSize: "14px", marginTop: "12px" }}>
                    ✔️ Check Verification Eligibility
                  </button>
                )}
              </>
            )}
          ...
          <div style={{ maxWidth: "800px", width: "100%" }}>
            ...
            {showTip && (
              <div style={{ marginTop: "16px", background: "var(--card)", borderRadius: "8px", padding: "16px", border: "1px solid var(--border)" }}>
                ...
                <div style={{ display: "flex", gap: "8px", marginBottom: "12px", flexWrap: "wrap" }}>
                  {[200, 500, 1000, 2000].map(amt => (
                    <button
                      ...
                      style={{
                        padding: "8px 16px",
                        background: tipAmount === amt ? "var(--red)" : "var(--bg)",
                        color: tipAmount === amt ? "white" : "var(--text)",
                ...
                <button
                  onClick={() => tipCreator(selectedMovie.creator_id, tipAmount, user?.email)}
                  style={{
                    width: "100%",
                    padding: "12px",
                    background: "var(--red)",
