...
function App() {
  ...
  const [isVerifiedCreator, setIsVerifiedCreator] = useState(localStorage.getItem("isVerifiedCreator") === "true");
  ...
  const fetchDashboard = async (id) => {
    try {
      ...
      localStorage.setItem("isVerifiedCreator", verified ? "true" : "false");
  ...
  const checkVerification = async () => {
    ...
    try {
      ...
      if (data.verified) {
        ...
        localStorage.setItem("isVerifiedCreator", "true");
  ...
  const registerCreator = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        localStorage.setItem("isVerifiedCreator", "false");
